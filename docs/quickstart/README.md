# ScryWatch — Integration Quickstart

Choose your stack:

| My stack | Integration path | Start here |
|----------|-----------------|------------|
| JavaScript / Node.js / browser | JS SDK | [`/js/README.md`](/js/README.md) |
| Flutter / Dart | Flutter SDK | [`/flutter/README.md`](/flutter/README.md) |
| PHP (standalone) | PHP package | [`/packages/php/README.md`](/packages/php/README.md) |
| PHP (Laravel) | Laravel package | [`/packages/laravel/README.md`](/packages/laravel/README.md) |
